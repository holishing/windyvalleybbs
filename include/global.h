...
/* ----------------------------------------------------- */
/* RSS設定 Author: hrs113355 Modify: cache               */
/* ----------------------------------------------------- */

#define FN_RSSCONF "rss.conf"    /* cache.090617: RSS設定 */
...
#define FN_ETC_NPC   "etc/npc"    /* Non-Player-Char npc  */
...
#define	FN_RUN_APPLY	"run/apply.log"	/* APPLY log */
...
#define FN_RUN_DELSCORE "run/delscore.log" /*刪除推文的紀錄*/
...
#define FN_RSS_FOLDER "etc/rss/"                /* 全站RSS設定的目錄 */
#define FN_RSS_LIST   "feed.list"   /* RSS feed list */
...
#define STR_ANONYMOUS	"不告訴你^^b"		/* 要短於 IDLEN 個字 */
...
#define INFO_MARK ANSI_COLOR(1;33) "★ "
...
VAR char *fn_rssconf INI(FN_RSSCONF);
